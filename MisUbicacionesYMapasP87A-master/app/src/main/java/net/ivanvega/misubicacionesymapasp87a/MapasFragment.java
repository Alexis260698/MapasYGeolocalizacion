        ...
        map.setOnMyLocationChangeListener(new GoogleMap.OnMyLocationChangeListener() {
            ...
            public void onMyLocationChange(Location location) {
                if(actualPosition){
                    ...
                    String url="https://maps.googleapis.com/maps/api/directions/json?origin="+latitudOrigen+","+longitudOrigen+"&destination=20.140186,-101.150595&key=AIzaSyDZx8ah9aVIZ57h7k1-V2DnivCSKNkLtXA";
